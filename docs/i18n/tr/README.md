...
> **Henüz npm'de yok.** Kaynaktan yükleyin. Bkz. [docs/installation.md](installation.md).
...
Tam kılavuz: [docs/quickstart.md](quickstart.md).
...
| Kılavuz | İçerik |
|---|---|
| [Kurulum](installation.md) | npm, pnpm, bun, kaynaktan ve VS Code uzantısı |
| [Hızlı başlangıç](quickstart.md) | Boş dizinden ilk REST/MCP çağrısına |
| [`.flow` dili](../../language.md) | `ACTION`, `RESOURCE`, `ENTITY`, tipler |
| [İş akışları](../../workflows.md) | `WORKFLOW`, `IF`/`SWITCH`, `PARALLEL` |
| [İzinler ve hız limiti](../../permissions.md) | Dört izin seviyesi |
| [CLI referansı](../../cli.md) | Tüm komutlar ve bayraklar |
