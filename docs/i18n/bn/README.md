...
> **এখনও npm-এ নেই।** সোর্স থেকে ইনস্টল করুন। দেখুন [docs/installation.md](installation.md)।
...
সম্পূর্ণ গাইড: [docs/quickstart.md](quickstart.md)।
...
| গাইড | বিষয়বস্তু |
|---|---|
| [ইনস্টলেশন](installation.md) | npm, pnpm, bun, সোর্স এবং VS Code এক্সটেনশন |
| [দ্রুত শুরু](quickstart.md) | খালি ডিরেক্টরি থেকে প্রথম REST/MCP কল পর্যন্ত |
| [`.flow` ভাষা](../../language.md) | `ACTION`, `RESOURCE`, `ENTITY`, টাইপ |
| [ওয়ার্কফ্লো](../../workflows.md) | `WORKFLOW`, `IF`/`SWITCH`, `PARALLEL` |
| [অনুমতি ও রেট লিমিট](../../permissions.md) | চারটি অনুমতি স্তর |
| [CLI রেফারেন্স](../../cli.md) | সমস্ত কমান্ড এবং ফ্ল্যাগ |
