...
> **尚未发布到 npm。** 请从源码安装。参见 [docs/installation.md](docs/installation.md)。
...
| 指南 | 内容 |
|---|---|
| [安装](docs/installation.md) | npm、pnpm、bun、从源码安装和 VS Code 扩展 |
| [快速开始](docs/quickstart.md) | 从空目录到第一次 REST 和 MCP 调用 |
| [`.flow` 语言](docs/language.md) | `ACTION`、`RESOURCE`、`ENTITY`、类型 |
| [工作流和控制流](docs/workflows.md) | `WORKFLOW`、`IF`/`SWITCH`、`PARALLEL` |
| [权限和速率限制](docs/permissions.md) | 四种权限级别、配额 |
| [CLI 参考](docs/cli.md) | 每个命令和标志 |
